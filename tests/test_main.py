...
from parsescrapegenerate import config, main
from parsescrapegenerate.exceptions import ConfigDoesNotExist, InvalidFeedFormat
...
class TestMain(unittest.TestCase):
    ...
    def test_scrape(self):
        ...
        self.assertIsInstance(main.scrape(conf), main.RssFeed)
...
class TestFeed(unittest.TestCase):
    ...
    def test_get_feed(self):
        ...
        """
        self.assertIsInstance(main._get_feed('rss'), main.RssFeed)
        self.assertIsInstance(main._get_feed('atom'), main.AtomFeed)
    ...
    def test_get_feed_invalid(self):
        ...
        raised.
        """
        self.assertRaises(InvalidFeedFormat, main._get_feed, 'foo')
...
class TestAtomFeed(unittest.TestCase):
    def setUp(self):
        self.atom_feed = main._get_feed('atom')
...
class TestRssFeed(unittest.TestCase):
    def setUp(self):
        self.rss_feed = main._get_feed('rss')
